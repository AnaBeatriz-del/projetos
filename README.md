...
Este é um projeto simples de um jogo feito com HTML (e possivelmente CSS/JavaScript no futuro). Ele roda direto no navegador e pode ser usado para praticar lógica, estrutura de páginas e desenvolvimento web básico.
